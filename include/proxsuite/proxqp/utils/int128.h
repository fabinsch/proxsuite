...
// #if defined(_MSC_VER)
// // In very old versions of MSVC and when the /Zc:wchar_t flag is off, wchar_t
// is
// // a typedef for unsigned short.  Otherwise wchar_t is mapped to the
// __wchar_t
...
public:
  ...
  //  // MakeUInt128()
  //   //
  //   // Constructs a `uint128` numeric value from two 64-bit unsigned
  //   integers.
...
std::ostream&
operator<<(std::ostream& os, uint128 v);
...
// //   * Explicit conversion to integral types
// //
// // However, an `int128` differs from intrinsic integral types in the
// following
// // ways:
// //
...
// // interoperable with that type. (Abseil checks for this compatibility
// through
// // the `ABSL_HAVE_INTRINSIC_INT128` macro.)
// //
...
// };
// std::ostream&
// operator<<(std::ostream& os, int128 v);
...
// Arithmetic operators.
constexpr uint128
operator<<(uint128 lhs, int amount);
constexpr uint128
operator>>(uint128 lhs, int amount);
constexpr uint128
...
constexpr uint128
AddResult(uint128 result, uint128 lhs)
{
  // check for carry
...
// namespace int128_internal {
// constexpr uint128
// SubstructResult(uint128 result, uint128 lhs, uint128 rhs)
// {
//   // check for carry
//   return (Uint128Low64(lhs) < Uint128Low64(rhs))
//            ? MakeUint128(Uint128High64(result) - 1, Uint128Low64(result))
...
{
// #if defined(ABSL_HAVE_INTRINSIC_INT128)
//   // TODO(strel) Remove once alignment issues are resolved and unsigned
//   __int128
...
// }
// constexpr int128
// MakeInt128(int64_t high, uint64_t low)
// {
...
// operator^(int128 lhs, int128 rhs);
// constexpr int128
// operator<<(int128 lhs, int amount);
// constexpr int128
// operator>>(int128 lhs, int amount);
// inline int128&
// int128::operator+=(int128 other)
...
// // representation.
// constexpr int64_t
// BitCastToSigned(uint64_t v)
// {
//   // Casting an unsigned integer to a signed integer of the same
//   // width is implementation defined behavior if the source value would not
//   fit
...
// #else                                             //
// ABSL_HAVE_INTRINSIC_INT128 #include "absl/numeric/int128_no_intrinsic.inc" //
// IWYU pragma: export #endif                                            //
// ABSL_HAVE_INTRINSIC_INT128 ABSL_NAMESPACE_END } // namespace absl #undef
...
// inline void DivModImpl(uint128 dividend, uint128 divisor, uint128*
// quotient_ret,
...
std::string
Uint128ToFormattedString(uint128 v, std::ios_base::fmtflags flags)
{
