...
#include <proxsuite/linalg/qdldl/cs.h>
   ...
   * @param  PtoKKT     (modified) index mapping from elements of P to KKT
   *matrix
   * @param  AtoKKT     (modified) index mapping from elements of A to KKT
   *matrix
   * @param  Pdiag_idx  (modified) Address of the index of diagonal elements in
   *P
   * @param  Pdiag_n    (modified) Address to the number of diagonal elements in
   *P
