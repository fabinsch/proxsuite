...
#include <proxsuite/linalg/qdldl/constants.h>
  ...
  typedef struct
  {
    ...
    c_int*
      p; ///< column pointers (size n+1); col indices (size nzmax) start from 0
         ///< when using triplet format (direct KKT matrix formation)
  ...
  typedef struct
  {
    ...
    c_int check_termination;  ///< integer, check termination interval; if 0,
                              ///< then termination checking is disabled
