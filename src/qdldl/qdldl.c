...
QDLDL_int
QDLDL_factor(const QDLDL_int n,
             const QDLDL_int* Ap,
             const QDLDL_int* Ai,
...
// Solves (L+I)x = b
void
QDLDL_Lsolve(const QDLDL_int n,
             const QDLDL_int* Lp,
             const QDLDL_int* Li,
...
// Solves (L+I)'x = b
void
QDLDL_Ltsolve(const QDLDL_int n,
              const QDLDL_int* Lp,
              const QDLDL_int* Li,
              const QDLDL_float* Lx,
              QDLDL_float* x)
